...
const galleryImages = [
  {
    id: 1,
    src: "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=400&h=600&fit=crop&crop=center",
    alt: "Mouvement fluide en danse contemporaine",
    caption: "Exploration de la fluidité"
  },
  {
    id: 2,
    src: "https://images.unsplash.com/photo-1547036967-23d11aacaee0?w=600&h=400&fit=crop&crop=center", 
    alt: "Expression gestuelle artistique",
    caption: "Langage corporel"
  },
  {
    id: 3,
    src: "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=400&h=500&fit=crop&crop=center",
    alt: "Danse dans l'espace scénique",
    caption: "Dialogue avec l'espace"
  },
  {
    id: 4,
    src: "https://images.unsplash.com/photo-1518834107812-67b0b7c58434?w=500&h=700&fit=crop&crop=center",
    alt: "Émotion à travers le mouvement",
    caption: "Transformation émotionnelle"
  },
  {
    id: 5,
    src: "https://images.unsplash.com/photo-1518834107812-67b0b7c58434?w=500&h=700&fit=crop&crop=center",
    alt: "Chorégraphie contemporaine",
    caption: "Poésie en mouvement"
  },
  {
    id: 6,
    src: "https://images.unsplash.com/photo-1518834107812-67b0b7c58434?w=500&h=700&fit=crop&crop=center",
    alt: "Expression artistique corporelle",
    caption: "Art du geste"
  },
  {
    id: 7,
    src: "https://images.unsplash.com/photo-1573920111312-04f1b25c6b85?w=500&h=400&fit=crop&crop=center",
    alt: "Performance de danse",
    caption: "Performance vivante"
  },
  {
    id: 8,
    src: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=550&fit=crop&crop=center",
    alt: "Création chorégraphique",
    caption: "Création pure"
  }
]

export default function DanseGallery() {
      ...
      >
        ...
        >
          ...
          <p className="text-xl font-playfair font-light text-muted-foreground max-w-2xl mx-auto">
            Instants capturés de nos créations dansées
          </p>
        </motion.div>
