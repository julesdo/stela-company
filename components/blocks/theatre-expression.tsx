...
const theatreElements = [
  {
    title: "Texte",
    description: "La parole devient chair, les mots se transforment en émotion pure. Chaque syllabe porte l'intention, chaque silence raconte une histoire."
  },
  {
    title: "Personnage",
    description: "L'art de devenir autre tout en restant soi. Explorer les facettes infinies de l'humain à travers le prisme de la fiction."
  },
  {
    title: "Mise en Scène", 
    description: "L'espace théâtral comme toile vierge où se dessinent les émotions, où chaque mouvement sculpte le récit."
  }
]

export default function TheatreExpression() {
      ...
      >
        ...
        >
          ...
          <p className="text-xl md:text-2xl font-playfair font-light text-muted-foreground leading-relaxed max-w-4xl mx-auto">
            Dans l'univers théâtral, Stela révèle les vérités cachées 
        ...
        >
          {theatreElements.map((element, index) => (
            <motion.div
              key={element.title}
        ...
        >
          <blockquote className="text-2xl md:text-3xl font-playfair font-light text-foreground leading-relaxed max-w-4xl mx-auto">
            "Le théâtre est un miroir où l'humanité 
            se contemple et se comprend."
          </blockquote>
